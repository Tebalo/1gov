...
const Submission: React.FC = () =>{
    const rowData: RowData[] = [
        { id: '67bf7nfe74unf843m', title: 'Teacher registration', date: '02 Feb 2024 - 12:48', status: 'Pending-Approval', action: ''  },
    ];
    return(
        <div>
            <div className="border-b-2 font-bold">
...
const Returned: React.FC = () =>{
    const rowData: RowData[] = [
        { id: '67bf7nfe74unf843m', title: 'Teacher registration', date: '02 Feb 2024 - 12:48', status: 'Pending-Payment', action: 'Pay' },
        { id: '67bf7nfe74unf843m', title: 'Teacher registration', date: '02 Feb 2024 - 12:48', status: 'Pending-Update', action: 'Update' },
    ];
    return(
        <div>
            <div className="border-b-2 font-bold">
