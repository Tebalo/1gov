...
import { updateChangeOfCategoryStatus, updateRestorationStatus, updateRevocationStatus } from '@/app/lib/actions'
...
import { StatusType } from '../types/restoration-type'
...
const RestorationActionButtons: React.FC<ActionButtonsProps> = ({ recordId, userRole, current_status }) => {
  ...
  const accessConfig: FlowActionConfig = getFlowActionUserDetails(userRole, current_status,'restoration') || {
    hasPermission: false,
    nextStatus: [],
    message: '',
    status_label: '',
...
export default  RestorationActionButtons;