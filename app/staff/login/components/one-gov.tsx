...
import { validateOTP, DeTokenize, storeSession, login_email } from "@/app/auth/auth"
...
export const OneGovID: React.FC = () => {
    ...
    const onSubmit = async (data: z.infer<typeof FormSchema>) => {
        ...
        try {
            ...
            const res = await login_email(formData)
            setAuthResponse(res)
        } catch (error) {
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Enter your primary email" type="email" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
