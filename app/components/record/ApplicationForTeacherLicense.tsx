...
export const ApplicationForTeacherLicense: React.FC<Work> = (data, userRole) => {
            ...
            <div className="w-full">
                <div className="flex w-full">
                    <div className="flex justify-center mb-2 w-full">
                        <span className="font-bold text-3xl text-gray-700">Application For Teacher License</span>
                    </div>
                </div>
