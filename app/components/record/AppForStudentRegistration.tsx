'use client'
import { learnerSteps, studentSteps } from "@/app/lib/store";
                ...
                <div className="flex md:m-5 w-full space-x-1 md:h-full">
                    ...
                    <div className="w-[calc(100%)] pr-2">
                        ...
                        <button 
                            type="button" 
                            onClick={next}
                            hidden={currentStep === studentSteps.length - 2}
                        ...
                        {(prev_status || inv_status || bar_status || rej_status) && (currentStep === studentSteps.length - 2) &&
                                <AlertDialog>
                            ...
                            {next_status && (currentStep === studentSteps.length - 2) &&
                                <AlertDialog>
                                    <AlertDialogTrigger asChild>
                            ...
                            {recommend && (currentStep === studentSteps.length - 2) &&
                                <AlertDialog>
                                        <AlertDialogTrigger asChild>
                            ...
                            {endorse && (currentStep === studentSteps.length - 2) &&
                                <AlertDialog>
                                        <AlertDialogTrigger asChild>
