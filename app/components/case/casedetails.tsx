const CaseDetails: React.FC = () => {
  return (       
    <>  
        <div className="items-start bg-gray-50 justify-start h-auto w-1/4">
            <div className="max-w-sm p-2 w-full bg-sky-500 border border-gray-200 shadow">
                <div className='flex gap-2 items-center'>
                    ...
                    <div className='font-sans text-white dark:text-white text-lg'>
                        <a href="#">
                            <p>R-00001</p>
            ...
            <div className='flex border-b-2 border-dotted border-gray-500 m-2 justify-start md:justify-between'>
                <button type="button" className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-full text-sm px-4 py-1.5 me-2 mb-2">
                    Refresh
                </button>
            </div>
