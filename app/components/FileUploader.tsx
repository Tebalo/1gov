...
export default function FileUploader(props: FileUploaderProps) {
    ...
    return (
        <div className="flex flex-col gap-4 w-full h-60 md:h-20">
            {
                uploadSuccess
                    ?
                    ...
                    <div className="form-control w-full">
                        <label className="label text-gray-900 text-xs space-x-1">
                        ...
                        <input
                            ...
                            hover:file:bg-sky-100 border rounded-lg"
            ...
            <div className="overflow-x-auto flex gap-2 flex-col-reverse">
                {Object.entries(fileProgress).map(([fileName, progress]) => (
                    <div key={fileName} className="text-xs text-gray-900 flex flex-col gap-1">
                        <p>{fileName}</p>
