        ...
        <>
            {isLoading ? (
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{response?.stud_teacher_registrations_count}</div>
                        <p className="text-xs text-muted-foreground">
                        +{response?.stud_teacher_registrations_count}% from last month
                        </p>
                    </CardContent>
                </Card>
                ):<></>
