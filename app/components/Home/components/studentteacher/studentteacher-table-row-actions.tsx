...
interface StudentTeacherDetailsDialogProps {
  isOpen: boolean
  onClose: () => void
  record: {
    national_id: string;
...
const StudentTeacherDetailsDialog: React.FC<StudentTeacherDetailsDialogProps> = ({
  isOpen,
  onClose,
  record,
  onOpen
...
export function StudentTeacherTableRowActions<TData>({
  row,
  userRole
...
export default StudentTeacherDetailsDialog