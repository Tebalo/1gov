...
import { RevocationColumns } from "./revocation-columns";
    ...
    return (
        <div className="h-full">
            {isLoading ? (
                ...
                <DataTable data={response} columns={RevocationColumns} userRole={userRole} />
            ) : (
                <DataTable data={[]} columns={RevocationColumns} userRole={userRole} />
            )}
        </div>
    )
}
