...
const TableFilter: React.FC = () => {
  ...
  return (
    <div className="w-full m-4 overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div>
            ...
            <div
                id="dropdownRadio"
                className={`z-10 ${isDropdownOpen ? 'block' : 'hidden'} w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}
      ...
      <tbody>
        {productData.map((item) => (
          ...
          >
            ...
            <td className="px-6 py-4">{item.applicationID}</td>
