...
export async function middleware(request: NextRequest) {
  ...
  const publicRoutes = ['/welcome', '/reports', '/reports/registrations', '/login', '/register', '/development','/development/accesscontrol','/development/components','/development/viewers'];
